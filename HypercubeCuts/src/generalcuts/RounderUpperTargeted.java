...
public class RounderUpperTargeted extends Rounder
{
	private static int _maxUpperRounding = 7;

	public RounderUpperTargeted(Instance instance)
	{
		super(instance);
	}
	...
	public static void setMaxRounding(int value)
	{
		_maxUpperRounding = value;
	}
}
